...
public class DateUtil {
    ...
    public final static String DATAFORMAT_YYYY_MM = "yyyy-MM";
    ...
    public final static String DATAFORMAT_YYYYMM = "yyyyMM";
    /**上一月*/
     ...
     * @date2017年11月24日
     */
    public static String getAfterTheDay(Date theDay, String pattern) {
        SimpleDateFormat sdf = new SimpleDateFormat(pattern);
     ...
     * @date2017年11月7日
     */
    public static Date getHistoryMonthFirstDay(Date date,int value){
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
